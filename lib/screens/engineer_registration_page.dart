...
class EngineerRegistrationPage extends StatefulWidget {
  @override
  _EngineerRegistrationPageState createState() => _EngineerRegistrationPageState();
}

class _EngineerRegistrationPageState extends State<EngineerRegistrationPage> {
  ...
  String? _validatePan(String? value) => value?.isEmpty ?? true ? 'PAN Number is required' : null;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Engineer Registration')),
      body: Padding(
              ...
              ElevatedButton(
                onPressed: () {
                  if (_formKey.currentState?.validate() ?? false) {
                    ...
                    print('Engineer Registration Successful');
                  } else {
